...
const ConceptDetails = ({ concept, repo, repoSummary, mappings, reverseMappings, loading, loadingOwnerMappings, ownerMappings, reverseOwnerMappings, onLoadOwnerMappings, includeRetired, onIncludeRetiredToggle, onCreateNewMapping, onUpdateMappingsSorting, onAssignSortWeight, onClearSortWeight, onRetireMapping, style }) => {
