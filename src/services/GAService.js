...
// of which env this app itself is running in. map./app. mirror this app's
// own env (e.g. app.v3.qa. -> map.qa., app.v3.qa. -> app.qa.).
const linkedDomains = () => {
  ...
  return [
    ...
    host.replace('app.v3.', 'map.'),
    host.replace('app.v3.', 'app.'),
  ];
};
